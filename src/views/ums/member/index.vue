  ...
  <PageWrapper>
    ...
    <MoneyForm :money-crud="moneyCrud" :rules="rules">
      ...
      <el-form-item label="余额" prop="balance">
        <ComputeInput v-model="moneyCrud.form.balance" />
      </el-form-item>
      <el-form-item label="地址">
        <PcdLinkage :province="moneyCrud.form.province" :city="moneyCrud.form.city" :district="moneyCrud.form.district"
          @change="pcdChange" class="w-full" />
      </el-form-item>
